...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (xah-fly-keys magit 0blayout which-key ergoemacs-mode org-bullets counsel powerline evil-mc flycheck exec-path-from-shell company-ycmd jedi ein slime auctex evil-tutor ox-reveal ox-ioslide makey f s el-get w3m evil goto-chg quelpa))))
(custom-set-faces
...
(if (eq system-type 'windows-nt nil)
